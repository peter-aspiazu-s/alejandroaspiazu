      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col w-72 md:w-80 h-[450px] md:h-[400px] m-auto">
            ...
            <div className="p-6 flex flex-col flex-1">
              <h5 className="text-lg font-semibold text-gray-800 mb-2">
                Motores Puertas Correderas
              </h5>
              <p className="text-gray-600 mb-4 flex-1">
                Ideales para portones que se deslizan lateralmente, robustos y confiables.
              </p>
              <a 
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col w-72 md:w-80 h-[400px] md:h-[400px] m-auto">
            ...
            <div className="p-6 flex flex-col flex-1">
              <h5 className="text-lg font-semibold text-gray-800 mb-2">
                Motores Puertas Basculantes
              </h5>
              <p className="text-gray-600 mb-4 flex-1">
                Perfectos para garajes residenciales, brindan confort y seguridad al máximo nivel.
              </p>
              <a 
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col w-72 md:w-80 h-[400px] md:h-[400px] m-auto">
            ...
            <div className="p-6 flex flex-col flex-1">
              ...
              <p className="text-gray-600 mb-4 flex-1">
                Solución para portones que abren hacia adentro o hacia afuera, elegantes y modernos.
              </p>
              <a 
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col w-72 md:w-80 h-[400px] md:h-[400px] m-auto">
            ...
            <div className="p-6 flex flex-col flex-1">
              <h5 className="text-lg font-semibold text-gray-800 mb-2">
                Motores Puertas Enrollables
              </h5>
              <p className="text-gray-600 mb-4 flex-1">
                Ideales para locales comerciales e industrias, resistentes y seguros.
              </p>
              <a 
